    ...
    <div className="group flex flex-col w-[90%] h-full justify-between mt-12 mb-5 border rounded-lg bg-gradient-to-br backdrop-blur-lg dark:from-white/15 dark:to-black/4 mx-auto shadow-md shadow-gray-400 dark:shadow-md dark:shadow-gray-400 md:h-full md:w-full lg:h-full lg:w-full md:mt-0 md:mb-0 lg:mt-0 lg:mb-0">
      ...
      <div>
        <div className="flex items-center justify-between mt-5 ml-4">
          ...
          <div className="flex flex-col ml-4 dark:text-white text-black">
            ...
            <a
              className="text-slate-500 dark:text-gray-400 cursor-pointer"
              onClick={() => {
                window.open("https://www.github.com/foskey51");
              }}
            >
              @foskey51
            </a>
          ...
          <div
            ...
            className="cursor-pointer ml-auto mr-6 px-2 dark:text-white text-black rounded-lg border-gray-300"
          >
            <button onClick={toggleDarkMode}>
              {darkMode ? (
                <IoBulbOutline className="size-6 hover:text-amber-300" />
              ) : (
                <MoonIcon className="size-5 hover:text-amber-500" />
              )}
            </button>
          </div>
        </div>
        ...
        <div className="mt-6 ml-6 mr-6 text-black dark:text-white">
          ...
          <p className="dark:text-gray-400 text-gray-600 text-xs pb-2">
            I use Arch btw
          </p>
          <div className="flex items-center gap-1 dark:text-gray-400 text-gray-600 text-xs font-sans pb-2">
            <MapPin size={19}/>
      ...
      <div className="flex flex-col items-end space-y-1 mt-4 mb-4 mr-4 md:mt-0">
        <div className="flex items-center space-x-2">
          ...
          <span className="dark:text-slate-400 text-gray-500 text-xs">
            Available For Work
          </span>
        </div>
