...
const HeaderCard = () => {
    ...
    return (
        <div className="flex flex-col w-[90%] h-full justify-between mt-12 mb-5 border rounded-lg bg-gradient-to-br backdrop-blur-lg dark:from-white/15 dark:to-black/4 mx-auto shadow-md shadow-gray-400 dark:shadow-md dark:shadow-gray-400 md:h-full md:w-full lg:h-full lg:w-full md:mt-0 md:mb-0 lg:mt-0 lg:mb-0">
            <div>
