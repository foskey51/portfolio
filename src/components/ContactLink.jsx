...
const ContactLink = () => {
    ...
    return (
        <>
            <div className="flex justify-center items-center space-x-6 w-[90%] pb-8 pt-4 mx-auto md:space-x-3 md:scale-90 lg:space-x-3 xl:space-x-5 md:pb-0 md:pt-0 lg:pb-0 lg:pt-0 hover:cursor-pointer">
