...
const ContactLink = () => {
    ...
    return (
        <>
            <div className="flex justify-center items-center space-x-6 w-[90%] pb-8 pt-4 mx-auto md:space-x-1 lg:space-x-2 md:pb-0 md:pt-0 lg:pb-0 lg:pt-0">
                ...
                <a onClick={() => { window.open('https://discord.com/users/1223184263667650639') }}>{<DiscordIcon className="size-14" />}</a>
            </div>
        </>
    );
};
